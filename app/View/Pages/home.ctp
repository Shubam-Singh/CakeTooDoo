...
<ul>
       <li><?php echo $this->Html->link('List all your tasks',
	array('controller' => 'tasks', 'action'=>'index')); ?></li>
       <li><?php echo $this->Html->link('List your completed tasks',
	array('controller' => 'tasks', 'action'=>'index','done'));
        ?></li>
       <li><?php echo $this->Html->link('List your pending tasks',
	array('controller' => 'tasks', 'action'=>'index',
	'pending')); ?></li>
       <li><?php echo $this->Html->link('Add new Tasks', array('controller'
	=> 'tasks', 'action'=>'add')); ?></li>
      <li>Edit tasks</li>
      <li>Delete tasks</li>
</ul>
